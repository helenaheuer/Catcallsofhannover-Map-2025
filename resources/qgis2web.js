...
map.getView().fit([1055909.977711, 6853165.635624, 1117392.201522, 6884970.862942], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Catcalls of Hannover | Map 2025</h2>';
        return titleElement;
    })(),
